...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "/* * {\n  border: 1px solid red;\n} */\n\n:root {\n  font-family: 'Roboto', sans-serif;\n}\n\nhtml {\n  box-sizing: border-box;\n}\n*,\n*:before,\n*:after {\n  box-sizing: inherit;\n}\n\nbody {\n  height: 100vh;\n  background-image: url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ");\n  background-color: #f1f3f4;\n  background-position: center;\n  background-size: cover;\n  background-repeat: no-repeat;\n  margin: 0;\n  padding: 0;\n  display: grid;\n  grid-template-rows: auto 1fr auto;\n  grid-template-areas:\n    \"header\"\n    \"main\"\n    \"footer\";\n}\n\nheader {\n  grid-area: header;\n  display: flex;\n  justify-content: center;\n  padding-top: 2rem;\n}\n\n.game-title {\n  font-size: 7rem;\n  font-weight: 600;\n}\n\n.main {\n  grid-area: main;\n  align-self: center;\n}\n\n.player-name-container {\n  background-color: #c2deec;\n  align-self: center;\n  padding: 0 1.5rem;\n  border: 1px solid #f1f3f4;\n  border-radius: 0.25rem;\n}\n\n.modal-place-ships-txt,\n.player1-name,\n.player2-name {\n  display: flex;\n  justify-content: center;\n  font-size: 1.9rem;\n  font-weight: 600;\n}\n\n.boards-container {\n  display: flex;\n  justify-content: center;\n  gap: 10rem;\n}\n\n.player1-board-container,\n.player2-board-container {\n  display: flex;\n  flex-direction: column;\n  gap: 1rem;\n}\n\n[class=\"modal-place-ships-board\"],\n[class=\"player1-board\"],\n[class=\"player2-board\"] {\n  background-color: #c2deec;\n  display: grid;\n  width: 450px;\n  height: 450px;\n  display: grid;\n  grid-template-columns: repeat(10, 1fr);\n  grid-template-rows: repeat(10, 1fr);\n  border: 10px solid #c2deec;\n  \n}\n\n.pos {\n  background-color: #269ad7;\n  border: 2.5px solid #c2deec;\n}\n\n.player2-board.pos:hover {\n  cursor: crosshair;\n  border: 5px double #f54140;\n}\n\n.modal-place-ships,\n.modal-game-over {\n  display: none;\n  position: fixed;\n  z-index: 1;\n  left: 0;\n  top: 0;\n  width: 100%;\n  height: 100%;\n  overflow: auto;\n  background-color: rgb(0,0,0);\n  background-color: rgba(0,0,0,0.4);\n}\n\n.modal-place-ships-content,\n.modal-game-over-content {\n  display: flex;\n  flex-direction: column;\n  background-color: #c2deec;\n  position: absolute;\n  left: 50%;\n  top: 50%;\n  transform: translate(-50%, -50%);\n  border: 1px solid #f1f3f4;\n  border-radius: 0.25rem;\n}\n\n.modal-place-ships-content {\n  padding: 0.5rem 0 1rem 0;\n  gap: 0.5rem;\n}\n\n.modal-game-over-content {\n  padding: 1.5rem;\n  gap: 1.25rem;\n}\n\n.modal-game-over-content-txt {\n  font-size: 3rem;\n  font-weight: 600;\n}\n\n.modal-place-ships-top-btn-container {\n  display: flex;\n  justify-content: center;\n  gap: 2rem;\n}\n\n.modal-place-ships-axis-btn,\n.modal-place-ships-random-btn,\n.modal-place-ships-clear-btn {\n  font-size: 1.25rem;\n  align-self: center;\n  padding: 0 1.25rem;\n  border: none;\n  border-radius: 0.25rem;\n  margin-top: 0.3rem;\n}\n\n.modal-place-ships-random-btn:hover,\n.modal-place-ships-axis-btn:hover,\n.modal-place-ships-clear-btn:hover {\n  cursor: pointer;\n  background-image: linear-gradient(rgb(0 0 0/3%) 0 0);\n}\n\n.modal-place-ships-board.pos:hover {\n  cursor: pointer;\n}\n\n.modal-place-ships-play-btn,\n.modal-game-over-content-reset-btn {\n  align-self: center;\n  border: 2px solid black;\n  border-radius: 0.25rem;\n  font-size: 1.5rem;\n  padding: 0 1.5rem;\n}\n\n.modal-place-ships-play-btn:hover,\n.modal-game-over-content-reset-btn:hover {\n  cursor: pointer;\n  color: white;\n  background-color: #269ad7;\n}\n\nfooter {\n  grid-area: footer;\n}\n\nfooter a {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  gap: 6px;\n  padding: 3px 0;\n  text-decoration: none;\n  color: black;\n}", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;;GAEG;;AAEH;EACE,iCAAiC;AACnC;;AAEA;EACE,sBAAsB;AACxB;AACA;;;EAGE,mBAAmB;AACrB;;AAEA;EACE,aAAa;EACb,yDAAmC;EACnC,yBAAyB;EACzB,2BAA2B;EAC3B,sBAAsB;EACtB,4BAA4B;EAC5B,SAAS;EACT,UAAU;EACV,aAAa;EACb,iCAAiC;EACjC;;;YAGU;AACZ;;AAEA;EACE,iBAAiB;EACjB,aAAa;EACb,uBAAuB;EACvB,iBAAiB;AACnB;;AAEA;EACE,eAAe;EACf,gBAAgB;AAClB;;AAEA;EACE,eAAe;EACf,kBAAkB;AACpB;;AAEA;EACE,yBAAyB;EACzB,kBAAkB;EAClB,iBAAiB;EACjB,yBAAyB;EACzB,sBAAsB;AACxB;;AAEA;;;EAGE,aAAa;EACb,uBAAuB;EACvB,iBAAiB;EACjB,gBAAgB;AAClB;;AAEA;EACE,aAAa;EACb,uBAAuB;EACvB,UAAU;AACZ;;AAEA;;EAEE,aAAa;EACb,sBAAsB;EACtB,SAAS;AACX;;AAEA;;;EAGE,yBAAyB;EACzB,aAAa;EACb,YAAY;EACZ,aAAa;EACb,aAAa;EACb,sCAAsC;EACtC,mCAAmC;EACnC,0BAA0B;;AAE5B;;AAEA;EACE,yBAAyB;EACzB,2BAA2B;AAC7B;;AAEA;EACE,iBAAiB;EACjB,0BAA0B;AAC5B;;AAEA;;EAEE,aAAa;EACb,eAAe;EACf,UAAU;EACV,OAAO;EACP,MAAM;EACN,WAAW;EACX,YAAY;EACZ,cAAc;EACd,4BAA4B;EAC5B,iCAAiC;AACnC;;AAEA;;EAEE,aAAa;EACb,sBAAsB;EACtB,yBAAyB;EACzB,kBAAkB;EAClB,SAAS;EACT,QAAQ;EACR,gCAAgC;EAChC,yBAAyB;EACzB,sBAAsB;AACxB;;AAEA;EACE,wBAAwB;EACxB,WAAW;AACb;;AAEA;EACE,eAAe;EACf,YAAY;AACd;;AAEA;EACE,eAAe;EACf,gBAAgB;AAClB;;AAEA;EACE,aAAa;EACb,uBAAuB;EACvB,SAAS;AACX;;AAEA;;;EAGE,kBAAkB;EAClB,kBAAkB;EAClB,kBAAkB;EAClB,YAAY;EACZ,sBAAsB;EACtB,kBAAkB;AACpB;;AAEA;;;EAGE,eAAe;EACf,oDAAoD;AACtD;;AAEA;EACE,eAAe;AACjB;;AAEA;;EAEE,kBAAkB;EAClB,uBAAuB;EACvB,sBAAsB;EACtB,iBAAiB;EACjB,iBAAiB;AACnB;;AAEA;;EAEE,eAAe;EACf,YAAY;EACZ,yBAAyB;AAC3B;;AAEA;EACE,iBAAiB;AACnB;;AAEA;EACE,aAAa;EACb,uBAAuB;EACvB,mBAAmB;EACnB,QAAQ;EACR,cAAc;EACd,qBAAqB;EACrB,YAAY;AACd","sourcesContent":["/* * {\n  border: 1px solid red;\n} */\n\n:root {\n  font-family: 'Roboto', sans-serif;\n}\n\nhtml {\n  box-sizing: border-box;\n}\n*,\n*:before,\n*:after {\n  box-sizing: inherit;\n}\n\nbody {\n  height: 100vh;\n  background-image: url(./img/bg.jpg);\n  background-color: #f1f3f4;\n  background-position: center;\n  background-size: cover;\n  background-repeat: no-repeat;\n  margin: 0;\n  padding: 0;\n  display: grid;\n  grid-template-rows: auto 1fr auto;\n  grid-template-areas:\n    \"header\"\n    \"main\"\n    \"footer\";\n}\n\nheader {\n  grid-area: header;\n  display: flex;\n  justify-content: center;\n  padding-top: 2rem;\n}\n\n.game-title {\n  font-size: 7rem;\n  font-weight: 600;\n}\n\n.main {\n  grid-area: main;\n  align-self: center;\n}\n\n.player-name-container {\n  background-color: #c2deec;\n  align-self: center;\n  padding: 0 1.5rem;\n  border: 1px solid #f1f3f4;\n  border-radius: 0.25rem;\n}\n\n.modal-place-ships-txt,\n.player1-name,\n.player2-name {\n  display: flex;\n  justify-content: center;\n  font-size: 1.9rem;\n  font-weight: 600;\n}\n\n.boards-container {\n  display: flex;\n  justify-content: center;\n  gap: 10rem;\n}\n\n.player1-board-container,\n.player2-board-container {\n  display: flex;\n  flex-direction: column;\n  gap: 1rem;\n}\n\n[class=\"modal-place-ships-board\"],\n[class=\"player1-board\"],\n[class=\"player2-board\"] {\n  background-color: #c2deec;\n  display: grid;\n  width: 450px;\n  height: 450px;\n  display: grid;\n  grid-template-columns: repeat(10, 1fr);\n  grid-template-rows: repeat(10, 1fr);\n  border: 10px solid #c2deec;\n  \n}\n\n.pos {\n  background-color: #269ad7;\n  border: 2.5px solid #c2deec;\n}\n\n.player2-board.pos:hover {\n  cursor: crosshair;\n  border: 5px double #f54140;\n}\n\n.modal-place-ships,\n.modal-game-over {\n  display: none;\n  position: fixed;\n  z-index: 1;\n  left: 0;\n  top: 0;\n  width: 100%;\n  height: 100%;\n  overflow: auto;\n  background-color: rgb(0,0,0);\n  background-color: rgba(0,0,0,0.4);\n}\n\n.modal-place-ships-content,\n.modal-game-over-content {\n  display: flex;\n  flex-direction: column;\n  background-color: #c2deec;\n  position: absolute;\n  left: 50%;\n  top: 50%;\n  transform: translate(-50%, -50%);\n  border: 1px solid #f1f3f4;\n  border-radius: 0.25rem;\n}\n\n.modal-place-ships-content {\n  padding: 0.5rem 0 1rem 0;\n  gap: 0.5rem;\n}\n\n.modal-game-over-content {\n  padding: 1.5rem;\n  gap: 1.25rem;\n}\n\n.modal-game-over-content-txt {\n  font-size: 3rem;\n  font-weight: 600;\n}\n\n.modal-place-ships-top-btn-container {\n  display: flex;\n  justify-content: center;\n  gap: 2rem;\n}\n\n.modal-place-ships-axis-btn,\n.modal-place-ships-random-btn,\n.modal-place-ships-clear-btn {\n  font-size: 1.25rem;\n  align-self: center;\n  padding: 0 1.25rem;\n  border: none;\n  border-radius: 0.25rem;\n  margin-top: 0.3rem;\n}\n\n.modal-place-ships-random-btn:hover,\n.modal-place-ships-axis-btn:hover,\n.modal-place-ships-clear-btn:hover {\n  cursor: pointer;\n  background-image: linear-gradient(rgb(0 0 0/3%) 0 0);\n}\n\n.modal-place-ships-board.pos:hover {\n  cursor: pointer;\n}\n\n.modal-place-ships-play-btn,\n.modal-game-over-content-reset-btn {\n  align-self: center;\n  border: 2px solid black;\n  border-radius: 0.25rem;\n  font-size: 1.5rem;\n  padding: 0 1.5rem;\n}\n\n.modal-place-ships-play-btn:hover,\n.modal-game-over-content-reset-btn:hover {\n  cursor: pointer;\n  color: white;\n  background-color: #269ad7;\n}\n\nfooter {\n  grid-area: footer;\n}\n\nfooter a {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  gap: 6px;\n  padding: 3px 0;\n  text-decoration: none;\n  color: black;\n}"],"sourceRoot":""}]);
// Exports
